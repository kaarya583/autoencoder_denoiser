...
archive=Path('/content/esp32_progress_backup_05.zip')
selected=set()
...
print('BACKUP05_BYTES',archive.stat().st_size)
print('BACKUP05_SHA256',hashlib.sha256(archive.read_bytes()).hexdigest())
print('BACKUP05_FILES',len(manifest))
